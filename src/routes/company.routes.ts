...
companyRouter.get('/user/:userId', asyncHandler(authorization([Roles.ADMINISTRATOR, Roles.ADMIN, Roles.DOCTOR, Roles.USER])), asyncHandler(companyController.findCompanyByUserId));
